...
const Index = ({ general, menu, post }) => {
  ...
  return (
    <Layout
      pageTitle={`Pengumuman, Berita, Informasi | ${general.organization}`}
    >
          ...
          <div className="container" data-aos="fade-up">
            <div className="row">
              ...
              <div className="col-lg-4">
                <Sidebar
                  sidebarTitle="Informasi Terbaru"
                  sub="pengumuman"
                  latest={post.latest}
                />
              </div>
...
export const getServerSideProps = async ({ query }) => {
  ...
  const res1 = await fetch(
    `https://eipiai.smpn33-sby.sch.id/public/posts?type=news&page_size=10&page=${page}`
  );
